...
// vice-versa. Ao final, mostre no console os valores que ficaram armazenados nas
// variáveis após modificadas.
...
console.log("Variavel A = ", valorA);
console.log("Variavel B = ", valorB);
